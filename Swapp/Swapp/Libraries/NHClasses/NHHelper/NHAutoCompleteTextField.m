...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([self.dataFilterDelegate respondsToSelector:@selector(AutoCompleteTableView:didSelectRowAtIndexPath:)])
    {
        [self.dataFilterDelegate AutoCompleteTableView:tableView didSelectRowAtIndexPath:indexPath];
    }
